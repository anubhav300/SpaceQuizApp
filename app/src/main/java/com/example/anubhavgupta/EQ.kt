...
class EQ : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mUserName = intent.getStringExtra(EQQ.USER_NAME)

        // TODO (STEP 3: Make the questions list and the current position variable global and remove the loEQ here.)
        // START
        mQuestionsList = EQQ.getQuestions()
        // END
                ...
                if (mSelectedOptionPosition == 0) {
                    ...
                    when {
                        ...
                        mCurrentPosition <= mQuestionsList!!.size -> {
                            ...
                            intent.putExtra(EQQ.CORRECT_ANSWERS, mCorrectAnswers)
                            intent.putExtra(EQQ.TOTAL_QUESTIONS, mQuestionsList!!.size)
