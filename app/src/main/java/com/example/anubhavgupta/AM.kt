...
class AM : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mUserName = intent.getStringExtra(AMQ.USER_NAME)

        // TODO (STEP 3: Make the questions list and the current position variable global and remove the loAM here.)
        // START
        mQuestionsList = AMQ.getQuestions()
        // END
                ...
                if (mSelectedOptionPosition == 0) {
                    ...
                    when {
                        ...
                        mCurrentPosition <= mQuestionsList!!.size -> {
                            ...
                            intent.putExtra(AMQ.CORRECT_ANSWERS, mCorrectAnswers)
                            intent.putExtra(AMQ.TOTAL_QUESTIONS, mQuestionsList!!.size)
