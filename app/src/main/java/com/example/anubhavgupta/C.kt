...
class C : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mUserName = intent.getStringExtra(CQ.USER_NAME)

        // TODO (STEP 3: Make the questions list and the current position variable global and remove the loC here.)
        // START
        mQuestionsList = CQ.getQuestions()
        // END
                ...
                if (mSelectedOptionPosition == 0) {
                    ...
                    when {
                        ...
                        mCurrentPosition <= mQuestionsList!!.size -> {
                            ...
                            intent.putExtra(CQ.CORRECT_ANSWERS, mCorrectAnswers)
                            intent.putExtra(CQ.TOTAL_QUESTIONS, mQuestionsList!!.size)
